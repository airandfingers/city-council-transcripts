You are the execution COORDINATOR for spec: hello-world
...
Read `./specs/hello-world/.ralph-state.json` to get current state:
...
1. Output error: "ERROR: State file missing or corrupt at ./specs/hello-world/.ralph-state.json"
...
Read `./specs/hello-world/tasks.md` and find the task at taskIndex (0-based).

**ERROR: Missing tasks.md**

If tasks.md does not exist:
1. Output error: "ERROR: Tasks file missing at ./specs/hello-world/tasks.md"
...
If spec directory does not exist (./specs/hello-world/):
1. Output error: "ERROR: Spec directory missing at ./specs/hello-world/"
...
```text
Task: Execute verification task $taskIndex for spec hello-world

Spec: hello-world
Path: ./specs/hello-world/
...
```text
Task: Execute task $taskIndex for spec hello-world
...
```text
[Task tool call 1]
Task: Execute task 3 for spec hello-world
progressFile: .progress-task-3.md
...

[Task tool call 2]
Task: Execute task 4 for spec hello-world
progressFile: .progress-task-4.md
...

[Task tool call 3]
Task: Execute task 5 for spec hello-world
...
```bash
git status --porcelain ./specs/hello-world/tasks.md ./specs/hello-world/.progress.md
```
...
```bash
grep -c '\- \[x\]' ./specs/hello-world/tasks.md
```
